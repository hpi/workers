...
def extract_checked_boxes(image_path):
    ...
    List all boxes with a pen-written “X” in the box to the left of the task description in the upper section of the document. Make sure to read the second column as well.
...
def main():
    ...
    if btf_type == "sod":
        results = extract_checked_boxes(os.path.join(script_path, "test-this-sod.png"))
    else:
        results = extract_checked_boxes(os.path.join(script_path, "test-this-eod.png"))
